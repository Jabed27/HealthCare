...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/firstedit.css">
       ...
       <div class="row first">
                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"style="margin:0 auto; float:none;">
                  <form action="" method="POST">
                    <h2 style="color:black">Edit Firstname</h2>
                    <input type="text"name = "email"placeholder="your email"></br></br>
                      <input type="text"name = "first"placeholder="your first name"></br></br>
                   ...
                   $conn = new mysqli($host,$userinfo,$password,$db);
                     ...
                     if(isset($_POST["changed"])){
                      ...
                      echo $first;
                      echo $email;
                      $query = "UPDATE userinfo set First_name='$first' where Email = '$email' ";
