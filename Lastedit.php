...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/lastedit.css">
       ...
       <div class="row last">
                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"style="margin:0 auto; float:none;">
                  <form action="" method="POST">
                    <h2 style="color:black">Edit Lasttname</h2>
                    <input type="text"name = "email"placeholder="your email"></br></br>
                      <input type="text"name = "last"placeholder="your last name"></br></br>
                   ...
                   $conn = new mysqli($host,$userinfo,$password,$db);
                     ...
                     if(isset($_POST["changed"])){
                      ...
                      $query = "UPDATE userinfo set Last_name='$last' where Email = '$email' ";
